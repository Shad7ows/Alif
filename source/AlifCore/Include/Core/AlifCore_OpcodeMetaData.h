...
const class OpcodeMetadata _alifOpcodeOpcodeMetadata_[266] = {
	...
	{ true, InstructionFormat::Instr_FMT_IB, HAS_ARG_FLAG }, // LOAD_SMALL_INT // 89
	{ true, InstructionFormat::Instr_FMT_IB, HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG }, // LOAD_SPECIAL // 90
	{ true, InstructionFormat::Instr_FMT_IBC, HAS_ARG_FLAG | HAS_NAME_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG }, // LOAD_SUPER_ATTR // 91
	{ true, InstructionFormat::Instr_FMT_IB, HAS_ARG_FLAG | HAS_FREE_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG }, // MAKE_CELL // 92
	{ true, InstructionFormat::Instr_FMT_IB, HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG }, // MAP_ADD // 93
	{ true, InstructionFormat::Instr_FMT_IB, HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG }, // MATCH_CLASS // 94
	{ true, InstructionFormat::Instr_FMT_IBC, HAS_ARG_FLAG | HAS_JUMP_FLAG }, // POP_JUMP_IF_FALSE // 95
	{ true, InstructionFormat::Instr_FMT_IBC, HAS_ARG_FLAG | HAS_JUMP_FLAG }, // POP_JUMP_IF_NONE // 96
	{ true, InstructionFormat::Instr_FMT_IBC, HAS_ARG_FLAG | HAS_JUMP_FLAG }, // POP_JUMP_IF_NOT_NONE // 97
	{ true, InstructionFormat::Instr_FMT_IBC, HAS_ARG_FLAG | HAS_JUMP_FLAG }, // POP_JUMP_IF_TRUE // 98
	{ true, InstructionFormat::Instr_FMT_IB, HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG }, // RAISE_VARARGS // 99
	{ true, InstructionFormat::Instr_FMT_IB, HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG }, // RERAISE // 100
	...
	{ true, InstructionFormat::Instr_FMT_IXC, HAS_DEOPT_FLAG }, // BINARY_SUBSCR_STR_INT // 160
	...
	{ true, InstructionFormat::Instr_FMT_IBC00, HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_EXIT_FLAG }, // CALL_ALIF_EXACT_ARGS // 180
	...
	{ true, InstructionFormat::Instr_FMT_IB, HAS_ARG_FLAG | HAS_CONST_FLAG }, // LOAD_CONST_IMMORTAL // 207
	...
	{ true, InstructionFormat::Instr_FMT_IBC, HAS_ARG_FLAG | HAS_NAME_FLAG | HAS_DEOPT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG }, // LOAD_SUPER_ATTR_ATTR // 210
	...
	{ true, InstructionFormat::Instr_FMT_IBC, HAS_ARG_FLAG | HAS_DEOPT_FLAG }, // UNPACK_SEQUENCE_TWO_TUPLE // 227
	{ false, -1 },
	{ false, -1 },
	{ false, -1 },
	{ false, -1 },
	...
	{ false, -1 },
	{ false, -1 },
	{ true, InstructionFormat::Instr_FMT_IX, HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG }, // INSTRUMENTED_END_FOR // 237
	...
	{ true, InstructionFormat::Instr_FMT_IX, HAS_ERROR_FLAG | HAS_ESCAPES_FLAG }, // INSTRUMENTED_RETURN_VALUE // 250
...
const uint8_t _alifOpcodeCaches_[256] = {
	...
	4, // LOAD_GLOBAL // 87
	0,0,0,
	1, // LOAD_SUPER_ATTR // 91
	0,0,0,
	1, // POP_JUMP_IF_FALSE // 95
	1, // POP_JUMP_IF_NONE // 96
	1, // POP_JUMP_IF_NOT_NONE // 97
	1, // POP_JUMP_IF_TRUE // 98
	0,0,
	1, // SEND // 101
	0,0,0,
	4, // STORE_ATTR // 105
...
const uint8_t _alifOpcodeDeopt_[256] = {
	...
	LOAD_SMALL_INT, // LOAD_SMALL_INT // 89
	LOAD_SPECIAL, // LOAD_SPECIAL // 90
	LOAD_SUPER_ATTR, // LOAD_SUPER_ATTR // 91
	MAKE_CELL, // MAKE_CELL // 92
	MAP_ADD, // MAP_ADD // 93
	MATCH_CLASS, // MATCH_CLASS // 94
	POP_JUMP_IF_FALSE, // POP_JUMP_IF_FALSE // 95
	POP_JUMP_IF_NONE, // POP_JUMP_IF_NONE // 96
	POP_JUMP_IF_NOT_NONE, // POP_JUMP_IF_NOT_NONE // 97
	POP_JUMP_IF_TRUE, // POP_JUMP_IF_TRUE // 98
	RAISE_VARARGS, // RAISE_VARARGS // 99
	RERAISE, // RERAISE // 100
	SEND, // SEND // 101
	SET_ADD, // SET_ADD // 102
	...
	LOAD_CONST, // LOAD_CONST_IMMORTAL // 207
	LOAD_GLOBAL, // LOAD_GLOBAL_BUILTIN // 208
	LOAD_GLOBAL, // LOAD_GLOBAL_MODULE // 209
	LOAD_SUPER_ATTR, // LOAD_SUPER_ATTR_ATTR // 210
	LOAD_SUPER_ATTR, // LOAD_SUPER_ATTR_METHOD // 211
	RESUME, // RESUME_CHECK // 212
	SEND, // SEND_GEN // 213
	STORE_ATTR, // STORE_ATTR_INSTANCE_VALUE // 214
	STORE_ATTR, // STORE_ATTR_SLOT // 215
	STORE_ATTR, // STORE_ATTR_WITH_HINT // 216
	STORE_SUBSCR, // STORE_SUBSCR_DICT // 217
	STORE_SUBSCR, // STORE_SUBSCR_LIST_INT // 218
	TO_BOOL, // TO_BOOL_ALWAYS_TRUE // 219
	TO_BOOL, // TO_BOOL_BOOL // 220
	TO_BOOL, // TO_BOOL_INT // 221
	TO_BOOL, // TO_BOOL_LIST // 222
	TO_BOOL, // TO_BOOL_NONE // 223
	TO_BOOL, // TO_BOOL_STR // 224
	UNPACK_SEQUENCE, // UNPACK_SEQUENCE_LIST // 225
	UNPACK_SEQUENCE, // UNPACK_SEQUENCE_TUPLE // 226
	UNPACK_SEQUENCE, // UNPACK_SEQUENCE_TWO_TUPLE // 227
	0,0,0,0,0,0,0,0,0,
	//INSTRUMENTED_END_FOR, // INSTRUMENTED_END_FOR // 237
	//INSTRUMENTED_END_SEND, // INSTRUMENTED_END_SEND // 238
	//INSTRUMENTED_LOAD_SUPER_ATTR, // INSTRUMENTED_LOAD_SUPER_ATTR // 239
	//INSTRUMENTED_FOR_ITER, // INSTRUMENTED_FOR_ITER // 240
	//INSTRUMENTED_CALL_KW, // INSTRUMENTED_CALL_KW // 241
	//INSTRUMENTED_CALL_FUNCTION_EX, // INSTRUMENTED_CALL_FUNCTION_EX // 242
	//INSTRUMENTED_INSTRUCTION, // INSTRUMENTED_INSTRUCTION // 243
	//INSTRUMENTED_JUMP_FORWARD, // INSTRUMENTED_JUMP_FORWARD // 244
	//INSTRUMENTED_POP_JUMP_IF_TRUE, // INSTRUMENTED_POP_JUMP_IF_TRUE // 245
	//INSTRUMENTED_POP_JUMP_IF_FALSE, // INSTRUMENTED_POP_JUMP_IF_FALSE // 246
	//INSTRUMENTED_POP_JUMP_IF_NONE, // INSTRUMENTED_POP_JUMP_IF_NONE // 247
	//INSTRUMENTED_POP_JUMP_IF_NOT_NONE, // INSTRUMENTED_POP_JUMP_IF_NOT_NONE // 248
	//INSTRUMENTED_RESUME, // INSTRUMENTED_RESUME // 249
	//INSTRUMENTED_RETURN_VALUE, // INSTRUMENTED_RETURN_VALUE // 250
