...
ALIFAPI_FUNC(AlifIntT) alifObject_isGC(AlifObject*); // 78

ALIFAPI_FUNC(AlifObject*) alifObject_init(AlifObject*, AlifTypeObject*); // 117
ALIFAPI_FUNC(AlifVarObject*) alifObject_initVar(AlifVarObject*, AlifTypeObject*, AlifSizeT); // 118

ALIFAPI_FUNC(AlifObject*) alifObject_new(AlifTypeObject*); // 127
...
ALIFAPI_FUNC(AlifVarObject*) _alifObject_gcResize(AlifVarObject*, AlifSizeT); // 159
#define ALIFOBJECT_GC_RESIZE(_type, _op, _n) \
                ( (_type *) _alifObject_gcResize(ALIFVAROBJECT_CAST(_op), (_n)) )


ALIFAPI_FUNC(AlifObject*) alifObject_gcNew(AlifTypeObject* _tp); // 165
ALIFAPI_FUNC(AlifVarObject*) alifObject_gcNewVar(AlifTypeObject*, AlifSizeT); // 166

ALIFAPI_FUNC(void) alifObject_gcTrack(void*); // 171


ALIFAPI_FUNC(void) alifObject_gcUnTrack(void*); // 176

ALIFAPI_FUNC(void) alifObject_gcDel(void*); // 178
